...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '16px', 'lineheight' => '22px', 'face' => '"Trebuchet MS", Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#bbbbbb'));
								
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '26px', 'lineheight' => '26px', 'face' => 'Ovo', 'style' => 'normal', 'character'  => 'latin', 'color' => '#373737'));
			
			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '26px', 'lineheight' => '36px', 'face' => 'Ovo', 'style' => 'normal', 'character'  => 'latin', 'color' => '#373737'));
			...
			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '26px', 'lineheight' => '26px', 'face' => 'Ovo', 'style' => 'normal', 'character'  => 'latin', 'color' => '#363636'));
								
			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '16px', 'lineheight' => '22px', 'face' => '"Trebuchet MS", Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#383939'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '71px', 'lineheight' => '71px', 'face' => 'Ovo', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '14px', 'lineheight' => '18px', 'face' => '"Trebuchet MS", Arial, Helvetica, sans-serif', 'style' => 'bold', 'character'  => 'latin', 'color' => '#454545'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '15px', 'lineheight' => '20px', 'face' => '"Trebuchet MS", Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#5b5b5b'));
